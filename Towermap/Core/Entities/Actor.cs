...
public class LevelActor : Entity
{
    ...
    public override void Update(double delta)
    {
        ...
        if (rect.Contains(gridX + (int)Data.Origin.X, gridY + (int)Data.Origin.Y)) 
        {
            ...
            if (Input.InputSystem.Mouse.LeftButton.IsPressed && scene.ToolSelected == Tool.Rect) 
            {
    ...
    public override void Draw(CommandBuffer buffer, IBatch spriteBatch)
    {
        ...
        DrawUtils.Rect(spriteBatch, Position, Color.Yellow * transparency, new Vector2(Width, Height), Data.Origin);
        ...
        {
            DrawUtils.Rect(spriteBatch, new Vector2(Transform.PosX + 320, Transform.PosY), Color.Yellow * transparency, new Vector2(Width, Height), Data.Origin);
        ...
        {
            DrawUtils.Rect(spriteBatch, new Vector2(Transform.PosX, Transform.PosY + 240), Color.Yellow * transparency, new Vector2(Width, Height), Data.Origin);
